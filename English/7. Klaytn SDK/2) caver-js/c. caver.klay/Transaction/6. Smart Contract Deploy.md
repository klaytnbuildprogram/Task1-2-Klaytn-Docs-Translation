...
Sends a Smart Contract Deploy transaction to the network.
...
The type of "SMART_CONTRACT_DEPLOY" transaction.
...
caver.klay.sendTransaction(transactionObject [, callback])
Sends a Fee Delegated Smart Contract Deploy transaction to the network.
...
The type of "FEE_DELEGATED_SMART_CONTRACT_DEPLOY" transaction.
...
caver.klay.sendTransaction(transactionObject [, callback])
Sends a Fee Delegated Smart Contract Deploy With Ratio transaction to the network.
...
The type of "FEE_DELEGATED_SMART_CONTRACT_DEPLOY_WITH_RATIO" transaction.
