...
- Please visit the Klaytn IDE website and create a `MyERC721Card` contract. The complete source code was given at [Writing ERC-721 smart contract](2-erc721.md).
...
![ERC721-2-mint-king](./images/ERC721-2-mint-king.png)
![ERC721-3-mint-queen](./images/ERC721-3-mint-queen.png)
...
You also have to configure `truffle-config.js` to deploy the smart contract to Klaytn network. This is the same step described at [Deploying a Smart Contract using Truffle](https://docs.klaytn.com/getting_started/quick_start#deploying-a-smart-contract-using-truffle)
```
// truffle-config.js
module.exports = {
    networks: {
