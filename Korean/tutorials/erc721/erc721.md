...
This tutorial helps you to create an example ERC-721 compatible token that conforms to [Klaytn Token Standards](https://docs.klaytn.com/klaytn/design/computation/token_standard), especially [Non-fungible Token Standard (ERC-721)](https://docs.klaytn.com/klaytn/design/computation/token_standard#non-fungible-token-standard-erc-721).
